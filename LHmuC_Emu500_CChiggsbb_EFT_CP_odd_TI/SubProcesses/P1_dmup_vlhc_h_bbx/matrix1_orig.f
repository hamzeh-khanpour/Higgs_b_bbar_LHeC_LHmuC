...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFS3_2(W(1,1),W(1,6),GC_38,MDL_MD, FK_ZERO,W(1,4))
      CALL FFV2_3(W(1,3),W(1,2),GC_13,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,5),W(1,7),GC_17,AMP(1))
      CALL FFS1_2(W(1,1),W(1,6),GC_34,MDL_MB, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,5),W(1,7),GC_19,AMP(2))
      CALL FFV2_3(W(1,1),W(1,5),GC_17,MDL_MW, ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,1),W(1,8),W(1,7),GC_17,AMP(5))
