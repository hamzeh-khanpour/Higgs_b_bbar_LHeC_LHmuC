...
C     
C     Process: u e- > ve h d WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WW) 
      ...
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 22
      CALL IXXXXX(P(0,2),MDL_ME,+1,+1*IC(2),W(1,3))  !  count 3
      CALL IXXXXX(P(0,2),MDL_ME,-1,+1*IC(2),W(1,4))  !  count 5
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,5))  !  count 12
      ...
      CALL OXXXXX(P(0,6),MDL_MD,-1,+1*IC(6),W(1,15))  !  count 18
      ...
      CALL FFS3_2(W(1,2),W(1,11),GC_44,MDL_MU,FK_ZERO,W(1,19))  !  count 1
      CALL FFS3_2(W(1,2),W(1,12),GC_44,MDL_MU,FK_ZERO,W(1,20))  !  count 1
      CALL FFS3_2(W(1,2),W(1,13),GC_44,MDL_MU,FK_ZERO,W(1,21))  !  count 3
      CALL FFV2_3(W(1,3),W(1,5),GC_13,MDL_MW,ZERO,W(1,22))  !  count 8
      CALL FFV2_3(W(1,4),W(1,5),GC_13,MDL_MW,ZERO,W(1,23))  !  count 32
      CALL FFV2P1N_1(W(1,15), W(1,23), GC_45, TMP(1))
      call CombineAmp(6,
     & (/2,1,8,5,10,6/), 
     & (/16,17,18,19,20,21/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,15), W(1,22), GC_45, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/18,21/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,14), W(1,23), GC_45, TMP(1))
      call CombineAmp(2,
     & (/9,7/), 
     & (/18,21/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,15),GC_45,MDL_MW,ZERO,W(1,24))  !  count 4
      CALL FFV2_3(W(1,2),W(1,14),GC_45,MDL_MW,ZERO,W(1,25))  !  count 4
      CALL FFV2_3(W(1,2),W(1,15),GC_45,MDL_MW,ZERO,W(1,26))  !  count 12
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFS3_2(W(1,4),W(1,11),GC_39,MDL_ME,FK_ZERO,W(1,30))  !  count 1
      CALL FFS3_2(W(1,4),W(1,12),GC_39,MDL_ME,FK_ZERO,W(1,31))  !  count 1
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFS3_1(W(1,14),W(1,10),GC_38,MDL_MD,FK_ZERO,W(1,33))  !  count 1
      CALL FFS3_1(W(1,14),W(1,13),GC_38,MDL_MD,FK_ZERO,W(1,34))  !  count 1
      CALL FFS3_1(W(1,15),W(1,10),GC_38,MDL_MD,FK_ZERO,W(1,35))  !  count 3
      CALL FFS3_1(W(1,15),W(1,11),GC_38,MDL_MD,FK_ZERO,W(1,36))  !  count 1
      CALL FFS3_1(W(1,15),W(1,12),GC_38,MDL_MD,FK_ZERO,W(1,37))  !  count 1
      CALL FFS3_1(W(1,15),W(1,13),GC_38,MDL_MD,FK_ZERO,W(1,38))  !  count 3
      CALL FFV2P1N_2(W(1,1), W(1,23), GC_45, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/35,38/),
     & TMP, W, AMP(1,4))
      CALL FFV2P1N_2(W(1,2), W(1,23), GC_45, TMP(1))
      call CombineAmp(6,
     & (/9,7,8,5,10,6/), 
     & (/33,34,35,36,37,38/),
     & TMP, W, AMP(1,4))
      CALL FFV2P1N_2(W(1,2), W(1,22), GC_45, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/35,38/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFS2_1(W(1,14),W(1,10),GC_52,MDL_MB,FK_ZERO,W(1,39))  !  count 1
      CALL FFS2_1(W(1,14),W(1,13),GC_52,MDL_MB,FK_ZERO,W(1,40))  !  count 1
      CALL FFS2_1(W(1,15),W(1,10),GC_52,MDL_MB,FK_ZERO,W(1,41))  !  count 3
      CALL FFS2_1(W(1,15),W(1,11),GC_52,MDL_MB,FK_ZERO,W(1,42))  !  count 1
      CALL FFS2_1(W(1,15),W(1,12),GC_52,MDL_MB,FK_ZERO,W(1,43))  !  count 1
      CALL FFS2_1(W(1,15),W(1,13),GC_52,MDL_MB,FK_ZERO,W(1,44))  !  count 3
