...
C     
C     Process: c e- > ve h d WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WW) 
      ...
      CALL OXXXXX(P(0,6),MDL_MD,+1,+1*IC(6),W(1,14))  !  count 7
      CALL OXXXXX(P(0,6),MDL_MD,-1,+1*IC(6),W(1,15))  !  count 20
      ...
      CALL FFS3_2(W(1,1),W(1,13),GC_37,MDL_MC,FK_ZERO,W(1,19))  !  count 1
      CALL FFS3_2(W(1,2),W(1,10),GC_37,MDL_MC,FK_ZERO,W(1,20))  !  count 3
      CALL FFS3_2(W(1,2),W(1,11),GC_37,MDL_MC,FK_ZERO,W(1,21))  !  count 1
      CALL FFS3_2(W(1,2),W(1,12),GC_37,MDL_MC,FK_ZERO,W(1,22))  !  count 1
      CALL FFS3_2(W(1,2),W(1,13),GC_37,MDL_MC,FK_ZERO,W(1,23))  !  count 3
      CALL FFV2_3(W(1,3),W(1,5),GC_13,MDL_MW,ZERO,W(1,24))  !  count 8
      CALL FFV2_3(W(1,4),W(1,5),GC_13,MDL_MW,ZERO,W(1,25))  !  count 40
      CALL FFV2P1N_1(W(1,15), W(1,25), GC_48, TMP(1))
      call CombineAmp(8,
     & (/3,1,4,2,10,7,12,8/), 
     & (/16,17,18,19,20,21,22,23/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,15), W(1,24), GC_48, TMP(1))
      call CombineAmp(2,
     & (/6,5/), 
     & (/20,23/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,14), W(1,25), GC_48, TMP(1))
      call CombineAmp(2,
     & (/11,9/), 
     & (/20,23/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,15),GC_48,MDL_MW,ZERO,W(1,26))  !  count 8
      CALL FFV2_3(W(1,2),W(1,14),GC_48,MDL_MW,ZERO,W(1,27))  !  count 4
      CALL FFV2_3(W(1,2),W(1,15),GC_48,MDL_MW,ZERO,W(1,28))  !  count 12
      CALL VVS1P1N_3(W(1,26), W(1,25), GC_32, TMP(1))
      call CombineAmpS(4,
     & (/3,1,4,2/), 
     & (/10,11,12,13/),
     & TMP, W, AMP(1,2))
      CALL VVS1P1N_3(W(1,27), W(1,25), GC_32, TMP(1))
      call CombineAmpS(2,
     & (/11,9/), 
     & (/10,13/),
     & TMP, W, AMP(1,2))
      CALL VVS1P1N_3(W(1,28), W(1,25), GC_32, TMP(1))
      call CombineAmpS(4,
     & (/10,7,12,8/), 
     & (/10,11,12,13/),
     & TMP, W, AMP(1,2))
      CALL VVS1P1N_3(W(1,28), W(1,24), GC_32, TMP(1))
      call CombineAmpS(2,
     & (/6,5/), 
     & (/10,13/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS3_2(W(1,3),W(1,10),GC_39,MDL_ME,FK_ZERO,W(1,29))  !  count 1
      CALL FFS3_2(W(1,3),W(1,13),GC_39,MDL_ME,FK_ZERO,W(1,30))  !  count 1
      CALL FFS3_2(W(1,4),W(1,10),GC_39,MDL_ME,FK_ZERO,W(1,31))  !  count 3
      CALL FFS3_2(W(1,4),W(1,11),GC_39,MDL_ME,FK_ZERO,W(1,32))  !  count 2
      CALL FFS3_2(W(1,4),W(1,12),GC_39,MDL_ME,FK_ZERO,W(1,33))  !  count 2
      CALL FFS3_2(W(1,4),W(1,13),GC_39,MDL_ME,FK_ZERO,W(1,34))  !  count 3
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFS3_1(W(1,14),W(1,10),GC_38,MDL_MD,FK_ZERO,W(1,35))  !  count 1
      CALL FFS3_1(W(1,14),W(1,13),GC_38,MDL_MD,FK_ZERO,W(1,36))  !  count 1
      CALL FFS3_1(W(1,15),W(1,10),GC_38,MDL_MD,FK_ZERO,W(1,37))  !  count 3
      CALL FFS3_1(W(1,15),W(1,11),GC_38,MDL_MD,FK_ZERO,W(1,38))  !  count 2
      CALL FFS3_1(W(1,15),W(1,12),GC_38,MDL_MD,FK_ZERO,W(1,39))  !  count 2
      CALL FFS3_1(W(1,15),W(1,13),GC_38,MDL_MD,FK_ZERO,W(1,40))  !  count 3
      CALL FFV2P1N_2(W(1,1), W(1,25), GC_48, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/37,38,39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV2P1N_2(W(1,2), W(1,25), GC_48, TMP(1))
      call CombineAmp(6,
     & (/11,9,10,7,12,8/), 
     & (/35,36,37,38,39,40/),
     & TMP, W, AMP(1,4))
      CALL FFV2P1N_2(W(1,2), W(1,24), GC_48, TMP(1))
      call CombineAmp(2,
     & (/6,5/), 
     & (/37,40/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFS2_1(W(1,14),W(1,10),GC_52,MDL_MB,FK_ZERO,W(1,41))  !  count 1
      CALL FFS2_1(W(1,14),W(1,13),GC_52,MDL_MB,FK_ZERO,W(1,42))  !  count 1
      CALL FFS2_1(W(1,15),W(1,10),GC_52,MDL_MB,FK_ZERO,W(1,43))  !  count 3
      CALL FFS2_1(W(1,15),W(1,11),GC_52,MDL_MB,FK_ZERO,W(1,44))  !  count 2
      CALL FFS2_1(W(1,15),W(1,12),GC_52,MDL_MB,FK_ZERO,W(1,45))  !  count 2
      CALL FFS2_1(W(1,15),W(1,13),GC_52,MDL_MB,FK_ZERO,W(1,46))  !  count 3
