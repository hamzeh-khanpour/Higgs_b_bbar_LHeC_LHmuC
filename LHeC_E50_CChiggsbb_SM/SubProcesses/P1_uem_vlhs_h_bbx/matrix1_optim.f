...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,3),I=0,6) /49,-1,-1,-1,-1, 1,-1/
      DATA (NHEL(I,4),I=0,6) /50,-1,-1,-1,-1, 1, 1/
      DATA (NHEL(I,5),I=0,6) /51,-1,-1,-1,-1,-1,-1/
      DATA (NHEL(I,6),I=0,6) /52,-1,-1,-1,-1,-1, 1/
      DATA (NHEL(I,7),I=0,6) /53,-1,-1,-1, 1, 1,-1/
      DATA (NHEL(I,8),I=0,6) /54,-1,-1,-1, 1, 1, 1/
      DATA (NHEL(I,9),I=0,6) /55,-1,-1,-1, 1,-1,-1/
      DATA (NHEL(I,10),I=0,6) /56,-1,-1,-1, 1,-1, 1/
      DATA IDEN/12/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WW) 
      ...
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,4))  !  count 11
      ...
      CALL FFS1_2_3(W(1,7),W(1,5),GC_36,GC_56,MDL_MH,FK_MDL_WH,W(1,9))  !  count 10
      CALL FFS1_2_3(W(1,7),W(1,6),GC_36,GC_56,MDL_MH,FK_MDL_WH,W(1,10))  !  count 8
      CALL FFS1_2_3(W(1,8),W(1,5),GC_36,GC_56,MDL_MH,FK_MDL_WH,W(1,11))  !  count 8
      CALL FFS1_2_3(W(1,8),W(1,6),GC_36,GC_56,MDL_MH,FK_MDL_WH,W(1,12))  !  count 10
      CALL OXXXXX(P(0,6),MDL_MS,+1,+1*IC(6),W(1,13))  !  count 13
      CALL OXXXXX(P(0,6),MDL_MS,-1,+1*IC(6),W(1,14))  !  count 16
      CALL FFS3_2(W(1,1),W(1,9),GC_44,MDL_MU,FK_ZERO,W(1,15))  !  count 1
      CALL FFS3_2(W(1,1),W(1,12),GC_44,MDL_MU,FK_ZERO,W(1,16))  !  count 1
      CALL FFS3_2(W(1,2),W(1,9),GC_44,MDL_MU,FK_ZERO,W(1,17))  !  count 2
      CALL FFS3_2(W(1,2),W(1,10),GC_44,MDL_MU,FK_ZERO,W(1,18))  !  count 2
      CALL FFS3_2(W(1,2),W(1,11),GC_44,MDL_MU,FK_ZERO,W(1,19))  !  count 2
      CALL FFS3_2(W(1,2),W(1,12),GC_44,MDL_MU,FK_ZERO,W(1,20))  !  count 2
      CALL FFV2_3(W(1,3),W(1,4),GC_13,MDL_MW,ZERO,W(1,21))  !  count 40
      CALL FFV2P1N_1(W(1,14), W(1,21), GC_46, TMP(1))
      call CombineAmp(6,
     & (/2,1,7,3,9,5/), 
     & (/15,16,17,18,19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,13), W(1,21), GC_46, TMP(1))
      call CombineAmp(4,
     & (/8,4,10,6/), 
     & (/17,18,19,20/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,14),GC_46,MDL_MW,ZERO,W(1,22))  !  count 4
      CALL FFV2_3(W(1,2),W(1,13),GC_46,MDL_MW,ZERO,W(1,23))  !  count 8
      CALL FFV2_3(W(1,2),W(1,14),GC_46,MDL_MW,ZERO,W(1,24))  !  count 8
      CALL VVS1P1N_3(W(1,22), W(1,21), GC_32, TMP(1))
      call CombineAmpS(2,
     & (/2,1/), 
     & (/9,12/),
     & TMP, W, AMP(1,2))
      CALL VVS1P1N_3(W(1,23), W(1,21), GC_32, TMP(1))
      call CombineAmpS(4,
     & (/8,4,10,6/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,2))
      CALL VVS1P1N_3(W(1,24), W(1,21), GC_32, TMP(1))
      call CombineAmpS(4,
     & (/7,3,9,5/), 
     & (/9,10,11,12/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFS3_2(W(1,3),W(1,9),GC_39,MDL_ME,FK_ZERO,W(1,25))  !  count 3
      CALL FFS3_2(W(1,3),W(1,10),GC_39,MDL_ME,FK_ZERO,W(1,26))  !  count 2
      CALL FFS3_2(W(1,3),W(1,11),GC_39,MDL_ME,FK_ZERO,W(1,27))  !  count 2
      CALL FFS3_2(W(1,3),W(1,12),GC_39,MDL_ME,FK_ZERO,W(1,28))  !  count 3
      CALL FFV2P1N_1(W(1,4), W(1,22), GC_13, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/25,28/),
     & TMP, W, AMP(1,3))
      CALL FFV2P1N_1(W(1,4), W(1,23), GC_13, TMP(1))
      call CombineAmp(4,
     & (/8,4,10,6/), 
     & (/25,26,27,28/),
     & TMP, W, AMP(1,3))
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFS4_1(W(1,13),W(1,9),GC_41,MDL_MS,FK_ZERO,W(1,29))  !  count 1
      CALL FFS4_1(W(1,13),W(1,10),GC_41,MDL_MS,FK_ZERO,W(1,30))  !  count 1
      CALL FFS4_1(W(1,13),W(1,11),GC_41,MDL_MS,FK_ZERO,W(1,31))  !  count 1
      CALL FFS4_1(W(1,13),W(1,12),GC_41,MDL_MS,FK_ZERO,W(1,32))  !  count 1
      CALL FFS4_1(W(1,14),W(1,9),GC_41,MDL_MS,FK_ZERO,W(1,33))  !  count 2
      CALL FFS4_1(W(1,14),W(1,10),GC_41,MDL_MS,FK_ZERO,W(1,34))  !  count 1
      CALL FFS4_1(W(1,14),W(1,11),GC_41,MDL_MS,FK_ZERO,W(1,35))  !  count 1
      CALL FFS4_1(W(1,14),W(1,12),GC_41,MDL_MS,FK_ZERO,W(1,36))  !  count 2
      CALL FFV2P1N_2(W(1,1), W(1,21), GC_46, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/33,36/),
     & TMP, W, AMP(1,4))
      CALL FFV2P1N_2(W(1,2), W(1,21), GC_46, TMP(1))
      call CombineAmp(8,
     & (/8,4,10,6,7,3,9,5/), 
     & (/29,30,31,32,33,34,35,36/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFS2_1(W(1,13),W(1,9),GC_54,MDL_MB,FK_ZERO,W(1,37))  !  count 1
      CALL FFS2_1(W(1,13),W(1,10),GC_54,MDL_MB,FK_ZERO,W(1,38))  !  count 1
      CALL FFS2_1(W(1,13),W(1,11),GC_54,MDL_MB,FK_ZERO,W(1,39))  !  count 1
      CALL FFS2_1(W(1,13),W(1,12),GC_54,MDL_MB,FK_ZERO,W(1,40))  !  count 1
      CALL FFS2_1(W(1,14),W(1,9),GC_54,MDL_MB,FK_ZERO,W(1,41))  !  count 2
      CALL FFS2_1(W(1,14),W(1,10),GC_54,MDL_MB,FK_ZERO,W(1,42))  !  count 1
      CALL FFS2_1(W(1,14),W(1,11),GC_54,MDL_MB,FK_ZERO,W(1,43))  !  count 1
      CALL FFS2_1(W(1,14),W(1,12),GC_54,MDL_MB,FK_ZERO,W(1,44))  !  count 2
      CALL FFV2P1N_2(W(1,1), W(1,21), GC_47, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/41,44/),
     & TMP, W, AMP(1,5))
      CALL FFV2P1N_2(W(1,2), W(1,21), GC_47, TMP(1))
      call CombineAmp(8,
     & (/8,4,10,6,7,3,9,5/), 
