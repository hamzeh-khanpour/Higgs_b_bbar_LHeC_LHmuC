...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,4),I=0,6) /51,-1,-1,-1,-1,-1,-1/
      DATA (NHEL(I,5),I=0,6) /52,-1,-1,-1,-1,-1, 1/
      DATA (NHEL(I,6),I=0,6) /53,-1,-1,-1, 1, 1,-1/
      DATA (NHEL(I,7),I=0,6) /54,-1,-1,-1, 1, 1, 1/
      DATA (NHEL(I,8),I=0,6) /55,-1,-1,-1, 1,-1,-1/
      DATA IDEN/12/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WW) 
      ...
      CALL IXXXXX(P(0,1),MDL_MU,-1,+1*IC(1),W(1,2))  !  count 18
      CALL IXXXXX(P(0,2),MDL_ME,-1,+1*IC(2),W(1,3))  !  count 5
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,4))  !  count 9
      ...
      CALL FFS1_2_3(W(1,7),W(1,6),GC_36,GC_56,MDL_MH,FK_MDL_WH,W(1,10))  !  count 5
      CALL FFS1_2_3(W(1,8),W(1,5),GC_36,GC_56,MDL_MH,FK_MDL_WH,W(1,11))  !  count 5
      CALL FFS1_2_3(W(1,8),W(1,6),GC_36,GC_56,MDL_MH,FK_MDL_WH,W(1,12))  !  count 10
      CALL OXXXXX(P(0,6),MDL_MD,+1,+1*IC(6),W(1,13))  !  count 7
      CALL OXXXXX(P(0,6),MDL_MD,-1,+1*IC(6),W(1,14))  !  count 16
      ...
      CALL FFS3_2(W(1,2),W(1,10),GC_44,MDL_MU,FK_ZERO,W(1,18))  !  count 1
      CALL FFS3_2(W(1,2),W(1,11),GC_44,MDL_MU,FK_ZERO,W(1,19))  !  count 1
      CALL FFS3_2(W(1,2),W(1,12),GC_44,MDL_MU,FK_ZERO,W(1,20))  !  count 2
      CALL FFV2_3(W(1,3),W(1,4),GC_13,MDL_MW,ZERO,W(1,21))  !  count 32
      CALL FFV2P1N_1(W(1,14), W(1,21), GC_45, TMP(1))
      call CombineAmp(6,
     & (/2,1,6,3,8,4/), 
     & (/15,16,17,18,19,20/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,13), W(1,21), GC_45, TMP(1))
      call CombineAmp(2,
     & (/7,5/), 
     & (/17,20/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,1),W(1,14),GC_45,MDL_MW,ZERO,W(1,22))  !  count 4
      CALL FFV2_3(W(1,2),W(1,13),GC_45,MDL_MW,ZERO,W(1,23))  !  count 4
      CALL FFV2_3(W(1,2),W(1,14),GC_45,MDL_MW,ZERO,W(1,24))  !  count 8
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFS3_2(W(1,3),W(1,10),GC_39,MDL_ME,FK_ZERO,W(1,26))  !  count 1
      CALL FFS3_2(W(1,3),W(1,11),GC_39,MDL_ME,FK_ZERO,W(1,27))  !  count 1
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFS3_1(W(1,13),W(1,9),GC_38,MDL_MD,FK_ZERO,W(1,29))  !  count 1
      CALL FFS3_1(W(1,13),W(1,12),GC_38,MDL_MD,FK_ZERO,W(1,30))  !  count 1
      CALL FFS3_1(W(1,14),W(1,9),GC_38,MDL_MD,FK_ZERO,W(1,31))  !  count 2
      CALL FFS3_1(W(1,14),W(1,10),GC_38,MDL_MD,FK_ZERO,W(1,32))  !  count 1
      CALL FFS3_1(W(1,14),W(1,11),GC_38,MDL_MD,FK_ZERO,W(1,33))  !  count 1
      CALL FFS3_1(W(1,14),W(1,12),GC_38,MDL_MD,FK_ZERO,W(1,34))  !  count 2
      CALL FFV2P1N_2(W(1,1), W(1,21), GC_45, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/31,34/),
     & TMP, W, AMP(1,4))
      CALL FFV2P1N_2(W(1,2), W(1,21), GC_45, TMP(1))
      call CombineAmp(6,
     & (/7,5,6,3,8,4/), 
     & (/29,30,31,32,33,34/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFS2_1(W(1,13),W(1,9),GC_52,MDL_MB,FK_ZERO,W(1,35))  !  count 1
      CALL FFS2_1(W(1,13),W(1,12),GC_52,MDL_MB,FK_ZERO,W(1,36))  !  count 1
      CALL FFS2_1(W(1,14),W(1,9),GC_52,MDL_MB,FK_ZERO,W(1,37))  !  count 2
      CALL FFS2_1(W(1,14),W(1,10),GC_52,MDL_MB,FK_ZERO,W(1,38))  !  count 1
      CALL FFS2_1(W(1,14),W(1,11),GC_52,MDL_MB,FK_ZERO,W(1,39))  !  count 1
      CALL FFS2_1(W(1,14),W(1,12),GC_52,MDL_MB,FK_ZERO,W(1,40))  !  count 2
