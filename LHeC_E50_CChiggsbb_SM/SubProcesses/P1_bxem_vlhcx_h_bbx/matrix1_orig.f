...
C     
C     Process: b~ e- > ve h c~ WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL IXXXXX(P(0,6),MDL_MC,NHEL(6),-1*IC(6),W(1,5))
      CALL FFS3_2(W(1,5),W(1,6),GC_37,MDL_MC, FK_ZERO,W(1,4))
      CALL FFV2_3(W(1,2),W(1,3),GC_13,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,1),W(1,7),GC_50,AMP(1))
      CALL FFV2_3(W(1,5),W(1,1),GC_50,MDL_MW, ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,8),W(1,7),GC_50,AMP(4))
      CALL FFS1_1(W(1,1),W(1,6),GC_34,MDL_MD, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,5),W(1,8),W(1,7),GC_48,AMP(5))
      CALL FFS1_1(W(1,1),W(1,6),GC_35,MDL_MS, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,8),W(1,7),GC_49,AMP(6))
