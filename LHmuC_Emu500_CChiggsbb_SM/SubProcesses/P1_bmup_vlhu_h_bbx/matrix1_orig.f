...
C     
C     Process: b mu+ > vm~ h u WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL OXXXXX(P(0,6),MDL_MU,NHEL(6),+1*IC(6),W(1,5))
      CALL FFS1_2_2(W(1,1),W(1,6),GC_36,GC_56,MDL_MB, FK_ZERO,W(1,4))
      CALL FFV2_3(W(1,3),W(1,2),GC_13,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,5),W(1,7),GC_16,AMP(1))
      CALL FFS2_2(W(1,1),W(1,6),GC_52,MDL_MD, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,5),W(1,7),GC_14,AMP(2))
      CALL FFS2_2(W(1,1),W(1,6),GC_54,MDL_MS, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,4),W(1,5),W(1,7),GC_15,AMP(3))
      CALL FFV2_3(W(1,1),W(1,5),GC_16,MDL_MW, ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFS3_1(W(1,5),W(1,6),GC_44,MDL_MU, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,1),W(1,8),W(1,7),GC_16,AMP(6))
