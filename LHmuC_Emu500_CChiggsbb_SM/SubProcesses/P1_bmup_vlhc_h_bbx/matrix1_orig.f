...
C     
C     Process: b mu+ > vm~ h c WEIGHTED<=6 @1
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFS3_1(W(1,5),W(1,6),GC_37,MDL_MC, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,1),W(1,8),W(1,7),GC_19,AMP(6))
