...
C     2 means approximation by the	denominator of the propagator
      ...
      DATA (NHEL(I,6),I=0,6) /51,-1, 1, 1,-1,-1,-1/
      DATA (NHEL(I,7),I=0,6) /52,-1, 1, 1,-1,-1, 1/
      DATA (NHEL(I,8),I=0,6) /53,-1, 1, 1, 1, 1,-1/
      DATA (NHEL(I,9),I=0,6) /54,-1, 1, 1, 1, 1, 1/
      DATA (NHEL(I,10),I=0,6) /55,-1, 1, 1, 1,-1,-1/
      DATA IDEN/12/
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WW) 
      ...
      CALL FFS1_2_3(W(1,8),W(1,7),GC_36,GC_56,MDL_MH,FK_MDL_WH,W(1,11))  !  count 5
      CALL FFS1_2_3(W(1,9),W(1,6),GC_36,GC_56,MDL_MH,FK_MDL_WH,W(1,12))  !  count 5
      CALL FFS1_2_3(W(1,9),W(1,7),GC_36,GC_56,MDL_MH,FK_MDL_WH,W(1,13))  !  count 12
      CALL OXXXXX(P(0,6),MDL_MU,+1,+1*IC(6),W(1,14))  !  count 7
      CALL OXXXXX(P(0,6),MDL_MU,-1,+1*IC(6),W(1,15))  !  count 22
      ...
      CALL FFS3_2(W(1,2),W(1,11),GC_38,MDL_MD,FK_ZERO,W(1,19))  !  count 1
      CALL FFS3_2(W(1,2),W(1,12),GC_38,MDL_MD,FK_ZERO,W(1,20))  !  count 1
      CALL FFS3_2(W(1,2),W(1,13),GC_38,MDL_MD,FK_ZERO,W(1,21))  !  count 3
      CALL FFV2_3(W(1,5),W(1,3),GC_13,MDL_MW,ZERO,W(1,22))  !  count 32
      CALL FFV2_3(W(1,5),W(1,4),GC_13,MDL_MW,ZERO,W(1,23))  !  count 8
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFS1_2(W(1,2),W(1,11),GC_34,MDL_MB,FK_ZERO,W(1,27))  !  count 1
      CALL FFS1_2(W(1,2),W(1,12),GC_34,MDL_MB,FK_ZERO,W(1,28))  !  count 1
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV2_3(W(1,2),W(1,15),GC_14,MDL_MW,ZERO,W(1,32))  !  count 12
     ...
     & TMP, W, AMP(1,3))  !  count 1
      ...
      CALL FFS3_1(W(1,4),W(1,13),GC_40,MDL_MMU,FK_ZERO,W(1,38))  !  count 1
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFS3_1(W(1,14),W(1,10),GC_44,MDL_MU,FK_ZERO,W(1,39))  !  count 1
      CALL FFS3_1(W(1,14),W(1,13),GC_44,MDL_MU,FK_ZERO,W(1,40))  !  count 1
      CALL FFS3_1(W(1,15),W(1,10),GC_44,MDL_MU,FK_ZERO,W(1,41))  !  count 3
      CALL FFS3_1(W(1,15),W(1,11),GC_44,MDL_MU,FK_ZERO,W(1,42))  !  count 1
      CALL FFS3_1(W(1,15),W(1,12),GC_44,MDL_MU,FK_ZERO,W(1,43))  !  count 1
      CALL FFS3_1(W(1,15),W(1,13),GC_44,MDL_MU,FK_ZERO,W(1,44))  !  count 3
