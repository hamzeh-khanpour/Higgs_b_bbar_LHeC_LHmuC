...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL IXXXXX(P(0,6),MDL_MS,NHEL(6),-1*IC(6),W(1,5))
      CALL FFS4_2(W(1,5),W(1,6),GC_41,MDL_MS, FK_ZERO,W(1,4))
      CALL FFV2_3(W(1,3),W(1,2),GC_13,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,1),W(1,7),GC_15,AMP(1))
      CALL FFS1_2(W(1,5),W(1,6),GC_35,MDL_MB, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,1),W(1,7),GC_16,AMP(2))
      CALL FFV2_3(W(1,5),W(1,1),GC_15,MDL_MW, ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,5),W(1,8),W(1,7),GC_15,AMP(5))
