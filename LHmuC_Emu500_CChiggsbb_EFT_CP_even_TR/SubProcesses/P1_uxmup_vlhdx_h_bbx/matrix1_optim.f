...
C     
C     Process: u~ mu+ > vm~ h d~ WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WW) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),MDL_MU,+1,-1*IC(1),W(1,1))  !  count 26
      ...
      CALL IXXXXX(P(0,3),ZERO,+1,-1*IC(3),W(1,5))  !  count 14
      ...
      CALL IXXXXX(P(0,6),MDL_MD,+1,-1*IC(6),W(1,14))  !  count 20
      CALL IXXXXX(P(0,6),MDL_MD,-1,-1*IC(6),W(1,15))  !  count 7
      CALL FFS3_2(W(1,14),W(1,10),GC_38,MDL_MD,FK_ZERO,W(1,16))  !  count 3
      CALL FFS3_2(W(1,14),W(1,11),GC_38,MDL_MD,FK_ZERO,W(1,17))  !  count 2
      CALL FFS3_2(W(1,14),W(1,12),GC_38,MDL_MD,FK_ZERO,W(1,18))  !  count 2
      CALL FFS3_2(W(1,14),W(1,13),GC_38,MDL_MD,FK_ZERO,W(1,19))  !  count 3
      ...
      CALL FFV2_3(W(1,5),W(1,3),GC_13,MDL_MW,ZERO,W(1,22))  !  count 32
      CALL FFV2_3(W(1,5),W(1,4),GC_13,MDL_MW,ZERO,W(1,23))  !  count 16
      CALL FFV2P1N_1(W(1,1), W(1,22), GC_14, TMP(1))
      call CombineAmp(6,
     & (/10,7,12,8,11,9/), 
     & (/16,17,18,19,20,21/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,1), W(1,23), GC_14, TMP(1))
      call CombineAmp(4,
     & (/5,3,6,4/), 
     & (/16,17,18,19/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,2), W(1,22), GC_14, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/16,19/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFS1_2(W(1,14),W(1,10),GC_34,MDL_MB,FK_ZERO,W(1,24))  !  count 3
      CALL FFS1_2(W(1,14),W(1,11),GC_34,MDL_MB,FK_ZERO,W(1,25))  !  count 2
      CALL FFS1_2(W(1,14),W(1,12),GC_34,MDL_MB,FK_ZERO,W(1,26))  !  count 2
      CALL FFS1_2(W(1,14),W(1,13),GC_34,MDL_MB,FK_ZERO,W(1,27))  !  count 3
      ...
      CALL FFV2P1N_1(W(1,1), W(1,22), GC_16, TMP(1))
      call CombineAmp(6,
     & (/10,7,12,8,11,9/), 
     & (/24,25,26,27,28,29/),
     & TMP, W, AMP(1,2))
      CALL FFV2P1N_1(W(1,1), W(1,23), GC_16, TMP(1))
      call CombineAmp(4,
     & (/5,3,6,4/), 
     & (/24,25,26,27/),
     & TMP, W, AMP(1,2))
      CALL FFV2P1N_1(W(1,2), W(1,22), GC_16, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/24,27/),
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV2_3(W(1,14),W(1,1),GC_14,MDL_MW,ZERO,W(1,30))  !  count 16
      CALL FFV2_3(W(1,14),W(1,2),GC_14,MDL_MW,ZERO,W(1,31))  !  count 4
      CALL FFV2_3(W(1,15),W(1,1),GC_14,MDL_MW,ZERO,W(1,32))  !  count 4
     ...
     & TMP, W, AMP(1,3))  !  count 1
      ...
      CALL FFS3_1(W(1,3),W(1,11),GC_40,MDL_MMU,FK_ZERO,W(1,34))  !  count 1
      CALL FFS3_1(W(1,3),W(1,12),GC_40,MDL_MMU,FK_ZERO,W(1,35))  !  count 1
      CALL FFS3_1(W(1,3),W(1,13),GC_40,MDL_MMU,FK_ZERO,W(1,36))  !  count 3
      CALL FFS3_1(W(1,4),W(1,10),GC_40,MDL_MMU,FK_ZERO,W(1,37))  !  count 1
      ...
      CALL FFS3_1(W(1,4),W(1,13),GC_40,MDL_MMU,FK_ZERO,W(1,40))  !  count 1
     ...
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFS3_1(W(1,1),W(1,10),GC_44,MDL_MU,FK_ZERO,W(1,41))  !  count 3
      CALL FFS3_1(W(1,1),W(1,11),GC_44,MDL_MU,FK_ZERO,W(1,42))  !  count 2
      CALL FFS3_1(W(1,1),W(1,12),GC_44,MDL_MU,FK_ZERO,W(1,43))  !  count 2
      CALL FFS3_1(W(1,1),W(1,13),GC_44,MDL_MU,FK_ZERO,W(1,44))  !  count 3
      CALL FFS3_1(W(1,2),W(1,10),GC_44,MDL_MU,FK_ZERO,W(1,45))  !  count 1
      CALL FFS3_1(W(1,2),W(1,13),GC_44,MDL_MU,FK_ZERO,W(1,46))  !  count 1
      CALL FFV2P1N_2(W(1,14), W(1,22), GC_14, TMP(1))
      call CombineAmp(6,
     & (/10,7,12,8,2,1/), 
     & (/41,42,43,44,45,46/),
     & TMP, W, AMP(1,5))
      CALL FFV2P1N_2(W(1,14), W(1,23), GC_14, TMP(1))
      call CombineAmp(4,
     & (/5,3,6,4/), 
     & (/41,42,43,44/),
     & TMP, W, AMP(1,5))
      CALL FFV2P1N_2(W(1,15), W(1,22), GC_14, TMP(1))
      call CombineAmp(2,
     & (/11,9/), 
     & (/41,44/),
