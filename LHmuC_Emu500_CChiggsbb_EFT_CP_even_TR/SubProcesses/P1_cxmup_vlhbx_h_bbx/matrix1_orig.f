...
C     
C     Process: c~ mu+ > vm~ h b~ WEIGHTED<=6 @1
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,1),W(1,7),GC_19,AMP(1))
      CALL FFS2_2(W(1,5),W(1,6),GC_52,MDL_MD, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,1),W(1,7),GC_17,AMP(2))
      CALL FFS2_2(W(1,5),W(1,6),GC_54,MDL_MS, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,4),W(1,1),W(1,7),GC_18,AMP(3))
      CALL FFV2_3(W(1,5),W(1,1),GC_19,MDL_MW, ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFS3_1(W(1,1),W(1,6),GC_37,MDL_MC, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,8),W(1,7),GC_19,AMP(6))
