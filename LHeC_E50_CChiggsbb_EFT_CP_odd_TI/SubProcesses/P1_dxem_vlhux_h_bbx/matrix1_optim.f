...
C     
C     Process: d~ e- > ve h u~ WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *small_width_treatment)), mdl_WW) 
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),MDL_MD,+1,-1*IC(1),W(1,1))  !  count 18
      CALL OXXXXX(P(0,1),MDL_MD,-1,-1*IC(1),W(1,2))  !  count 7
      ...
      CALL IXXXXX(P(0,6),MDL_MU,+1,-1*IC(6),W(1,14))  !  count 22
      CALL IXXXXX(P(0,6),MDL_MU,-1,-1*IC(6),W(1,15))  !  count 7
      CALL FFS3_2(W(1,14),W(1,10),GC_44,MDL_MU,FK_ZERO,W(1,16))  !  count 3
      CALL FFS3_2(W(1,14),W(1,11),GC_44,MDL_MU,FK_ZERO,W(1,17))  !  count 1
      CALL FFS3_2(W(1,14),W(1,12),GC_44,MDL_MU,FK_ZERO,W(1,18))  !  count 1
      ...
      CALL FFV2P1N_1(W(1,1), W(1,22), GC_45, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/16,19/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,1), W(1,23), GC_45, TMP(1))
      call CombineAmp(6,
     & (/8,5,10,6,9,7/), 
     & (/16,17,18,19,20,21/),
     & TMP, W, AMP(1,1))
      CALL FFV2P1N_1(W(1,2), W(1,23), GC_45, TMP(1))
      call CombineAmp(2,
     & (/2,1/), 
     & (/16,19/),
     & TMP, W, AMP(1,1))  !  count 1
      CALL FFV2_3(W(1,14),W(1,1),GC_45,MDL_MW,ZERO,W(1,24))  !  count 12
      CALL FFV2_3(W(1,14),W(1,2),GC_45,MDL_MW,ZERO,W(1,25))  !  count 4
      CALL FFV2_3(W(1,15),W(1,1),GC_45,MDL_MW,ZERO,W(1,26))  !  count 4
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFS3_1(W(1,1),W(1,10),GC_38,MDL_MD,FK_ZERO,W(1,33))  !  count 3
      CALL FFS3_1(W(1,1),W(1,11),GC_38,MDL_MD,FK_ZERO,W(1,34))  !  count 1
      CALL FFS3_1(W(1,1),W(1,12),GC_38,MDL_MD,FK_ZERO,W(1,35))  !  count 1
      CALL FFS3_1(W(1,1),W(1,13),GC_38,MDL_MD,FK_ZERO,W(1,36))  !  count 3
      CALL FFS3_1(W(1,2),W(1,10),GC_38,MDL_MD,FK_ZERO,W(1,37))  !  count 1
      CALL FFS3_1(W(1,2),W(1,13),GC_38,MDL_MD,FK_ZERO,W(1,38))  !  count 1
      CALL FFV2P1N_2(W(1,14), W(1,22), GC_45, TMP(1))
      call CombineAmp(2,
     & (/4,3/), 
     & (/33,36/),
     & TMP, W, AMP(1,4))
      CALL FFV2P1N_2(W(1,14), W(1,23), GC_45, TMP(1))
      call CombineAmp(6,
     & (/8,5,10,6,2,1/), 
     & (/33,34,35,36,37,38/),
     & TMP, W, AMP(1,4))
      CALL FFV2P1N_2(W(1,15), W(1,23), GC_45, TMP(1))
      call CombineAmp(2,
     & (/9,7/), 
     & (/33,36/),
     & TMP, W, AMP(1,4))  !  count 1
      CALL FFS2_1(W(1,1),W(1,10),GC_52,MDL_MB,FK_ZERO,W(1,39))  !  count 3
      CALL FFS2_1(W(1,1),W(1,11),GC_52,MDL_MB,FK_ZERO,W(1,40))  !  count 1
      CALL FFS2_1(W(1,1),W(1,12),GC_52,MDL_MB,FK_ZERO,W(1,41))  !  count 1
      CALL FFS2_1(W(1,1),W(1,13),GC_52,MDL_MB,FK_ZERO,W(1,42))  !  count 3
      CALL FFS2_1(W(1,2),W(1,10),GC_52,MDL_MB,FK_ZERO,W(1,43))  !  count 1
      CALL FFS2_1(W(1,2),W(1,13),GC_52,MDL_MB,FK_ZERO,W(1,44))  !  count 1
