...
C     
C     Process: u e- > ve h b WEIGHTED<=6 @1
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL OXXXXX(P(0,6),MDL_MB,NHEL(6),+1*IC(6),W(1,5))
      CALL FFS3_2(W(1,1),W(1,6),GC_44,MDL_MU, FK_ZERO,W(1,4))
      CALL FFV2_3(W(1,2),W(1,3),GC_13,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,5),W(1,7),GC_47,AMP(1))
      CALL FFV2_3(W(1,1),W(1,5),GC_47,MDL_MW, ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFS1_2_1(W(1,5),W(1,6),GC_36,GC_56,MDL_MB, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,1),W(1,8),W(1,7),GC_47,AMP(4))
      CALL FFS1_1(W(1,5),W(1,6),GC_34,MDL_MD, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,1),W(1,8),W(1,7),GC_45,AMP(5))
      CALL FFS1_1(W(1,5),W(1,6),GC_35,MDL_MS, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,1),W(1,8),W(1,7),GC_46,AMP(6))
